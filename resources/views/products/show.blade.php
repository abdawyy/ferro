...
@section('og_image',        $product->featured_image ? ferro_public_url($product->featured_image) : (ferro_storefront_media('brand.og_default') ?? asset('images/ferro-og-default.png')))
